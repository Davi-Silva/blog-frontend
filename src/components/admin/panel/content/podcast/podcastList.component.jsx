...
export default class List extends Component {
  ...
  async onDeletePodcast() {
    ...
    await fetch(
      `http://52.70.19.141:5000/podcasts/delete/audio/${audioFileId}`,
      {
        method: 'DELETE',
        mode: 'cors',
        cache: 'no-cache',
    ...
    await fetch(
      `http://52.70.19.141:5000/podcasts/delete/cover/${coverFileId}`,
      {
        method: 'DELETE',
        mode: 'cors',
        cache: 'no-cache',
    ...
    await fetch(`http://52.70.19.141:5000/podcasts/delete/${id}`, {
      method: 'DELETE',
      mode: 'cors',
      cache: 'no-cache',
      credentials: 'same-origin',
  ...
  async getPodcastBySlug() {
    ...
    this.response = await fetch(
      `http://52.70.19.141:5000/podcasts/get/${slug}`,
      {
        method: 'GET',
        mode: 'cors',
        cache: 'no-cache',
