...
const RegisterAdmin = () => {
  ...
  const RegisterAdminUser = async (adminRegisterInfo) => {
    ...
    const response = await fetch('http://34.196.97.115:5000/admin/user/register/admin',
      {
        method: 'POST',
        mode: 'cors',
        cache: 'no-cache',
  ...
  const verifyAdminUser = async () => {
    const response = await fetch(`http://34.196.97.115:5000/admin/user/verify/admin/username/${adminUser}`,
      {
        method: 'GET',
        mode: 'cors',
        cache: 'no-cache',
  ...
  const LoginSU = async (userInfo) => {
    const response = await fetch('http://34.196.97.115:5000/admin/user/verify/su',
      {
        method: 'POST',
        mode: 'cors',
        cache: 'no-cache',
