...
export default class UploadNewPodcast extends Component {
  ...
  async verifySlug(slug) {
    let response = await fetch(
      `http://52.70.19.141:5000/podcasts/validation/slug/${slug}`,
      {
        method: "GET",
        mode: "cors",
        cache: "no-cache",
  ...
  async uploadPodcast(podcast) {
    let response = await fetch(
      `http://52.70.19.141:5000/podcasts/upload`,
      {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
  ...
  async setGlobalVariable() {
    let bodyRequest = {
      ...
      let response = fetch("http://52.70.19.141:5000/podcasts/set/global-variable", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "same-origin",
