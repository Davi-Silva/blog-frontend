...
import * as PodcastsByTagsAction from '../../store/actions/podcasts/podcastsByTag';

const PodcastsByTag = (props) => {
  const podcasts = useSelector((state) => state.podcastsByTag);
  ...
  useEffect(() => {
    ...
    dispatch(PodcastsByTagsAction.getPodcastsByTag(slug));
  }, []);
